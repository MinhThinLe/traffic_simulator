...
public class Bus extends Vehicle {
    private static final float DEFAULT_SPEED = 55;
    private static final float WIDTH = 55;
    private static final float HEIGHT = 22;
    private static final String VEHICLE_NAME = "Bus";
    ...
    public Bus(ArrayList<Road> path, Vector2 position) {
        super(path, position, DrivingMode.CAREFUL, DEFAULT_SPEED);
    }
