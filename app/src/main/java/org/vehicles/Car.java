...
public class Car extends Vehicle {
    ...
    public Car(ArrayList<Road> path, Vector2 position) {
        super(path, position, DrivingMode.NORMAL, DEFAULT_SPEED);
    }
    ...
    private void drawText() {
        LabelStyle style = new LabelStyle(Renderer.textRenderer, Color.WHITE);
